...
return [
    ...
    'questions' => [
        ...
        'technical' => [
            ...
            "J'aimerais vérifier par moi même le code source, où puis-je le trouver ?" => "Avec grand plaisir ! Le code source se trouve à l'adresse suivante : https://framagit.org/Korko/SecretSanta. Vous pouvez aussi trouver le lien en haut à droite de la page principale, dans le petit ruban rouge.",
        ],
    ],
];
