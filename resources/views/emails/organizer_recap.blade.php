...
@section('content')
    ...
    @if($nextSolvable)<p style="padding-bottom:10px !important">À compter du {{ $expirationDate }}, un second récapitulatif sera disponible contenant la cible tirée au hasard par chaque participant dans leur liste d'exclusions respectives. Améliorant encore plus l'expérience pour le prochain évènement.</p>@endif
