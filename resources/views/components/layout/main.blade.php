...
<html lang="{{ App::getLocale() }}">
    ...
    <body class="text-independance font-happy-kids">
        <noscript>
            {{ __('Pour une expérience complète, ce site internet a besoin que vous activiez le JavaScript dans votre navigateur.') }}
        </noscript>
