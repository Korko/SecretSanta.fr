 ...
 */
    ...
    namespace Illuminate\Support\Facades {use App\Console\Kernel;use App\User;use BadMethodCallException;use Closure;use Countable;use DateInterval;use DateTimeInterface;use Doctrine\DBAL\DBALException;use Doctrine\DBAL\Schema\AbstractSchemaManager;use Doctrine\DBAL\Schema\Column;use Exception;use Generator;use GuzzleHttp\Promise\PromiseInterface;use Illuminate\Auth\Access\AuthorizationException;use Illuminate\Auth\Access\iterable;use Illuminate\Auth\AuthenticationException;use Illuminate\Auth\AuthManager;use Illuminate\Auth\Passwords\PasswordBrokerManager;use Illuminate\Auth\Passwords\TokenRepositoryInterface;use Illuminate\Auth\SessionGuard;use Illuminate\Auth\TokenGuard;use Illuminate\Broadcasting\Broadcasters\Broadcaster;use Illuminate\Broadcasting\BroadcastManager;use Illuminate\Broadcasting\PendingBroadcast;use Illuminate\Bus\Batch;use Illuminate\Bus\PendingBatch;use Illuminate\Cache\ArrayStore;use Illuminate\Cache\CacheManager;use Illuminate\Cache\TaggedCache;use Illuminate\Config\Repository;use Illuminate\Container\array;use Illuminate\Contracts\Auth\Authenticatable;use Illuminate\Contracts\Auth\CanResetPassword;use Illuminate\Contracts\Auth\Guard;use Illuminate\Contracts\Auth\PasswordBroker;use Illuminate\Contracts\Auth\StatefulGuard;use Illuminate\Contracts\Auth\UserProvider;use Illuminate\Contracts\Cache\Lock;use Illuminate\Contracts\Container\BindingResolutionException;use Illuminate\Contracts\Container\CircularDependencyException;use Illuminate\Contracts\Container\Container;use Illuminate\Contracts\Container\ContextualBindingBuilder;use Illuminate\Contracts\Cookie\QueueingFactory;use Illuminate\Contracts\Encryption\DecryptException;use Illuminate\Contracts\Encryption\EncryptException;use Illuminate\Contracts\Events\Dispatcher;use Illuminate\Contracts\Filesystem\Cloud;use Illuminate\Contracts\Filesystem\FileExistsException;use Illuminate\Contracts\Filesystem\FileNotFoundException;use Illuminate\Contracts\Foundation\Application;use Illuminate\Contracts\Mail\Mailable;use Illuminate\Contracts\Queue\Job;use Illuminate\Contracts\Support\Arrayable;use Illuminate\Contracts\Support\Htmlable;use Illuminate\Contracts\Translation\Loader;use Illuminate\Contracts\Translation\Translator;use Illuminate\Contracts\View\Engine;use Illuminate\Cookie\CookieJar;use Illuminate\Database\Connection;use Illuminate\Database\DatabaseManager;use Illuminate\Database\DatabaseTransactionsManager;use Illuminate\Database\Eloquent\ModelNotFoundException;use Illuminate\Database\Grammar;use Illuminate\Database\MySqlConnection;use Illuminate\Database\Query\Builder;use Illuminate\Database\Query\Expression;use Illuminate\Database\Query\Processors\Processor;use Illuminate\Database\Schema\MySqlBuilder;use Illuminate\Database\Schema\MySqlSchemaState;use Illuminate\Encryption\Encrypter;use Illuminate\Filesystem\Filesystem;use Illuminate\Filesystem\FilesystemAdapter;use Illuminate\Filesystem\FilesystemManager;use Illuminate\Foundation\Bus\PendingChain;use Illuminate\Foundation\Bus\PendingDispatch;use Illuminate\Foundation\Console\ClosureCommand;use Illuminate\Foundation\never;use Illuminate\Hashing\Argon2IdHasher;use Illuminate\Hashing\ArgonHasher;use Illuminate\Hashing\BcryptHasher;use Illuminate\Hashing\HashManager;use Illuminate\Http\Client\PendingRequest;use Illuminate\Http\Client\ResponseSequence;use Illuminate\Http\JsonResponse;use Illuminate\Http\RedirectResponse;use Illuminate\Http\UploadedFile;use Illuminate\Log\Logger;use Illuminate\Log\LogManager;use Illuminate\Mail\Mailer;use Illuminate\Mail\MailManager;use Illuminate\Mail\PendingMail;use Illuminate\Notifications\ChannelManager;use Illuminate\Queue\DatabaseQueue;use Illuminate\Queue\Jobs\DatabaseJob;use Illuminate\Queue\Jobs\DatabaseJobRecord;use Illuminate\Queue\QueueManager;use Illuminate\Routing\Exceptions\UrlGenerationException;use Illuminate\Routing\PendingResourceRegistration;use Illuminate\Routing\Redirector;use Illuminate\Routing\ResponseFactory;use Illuminate\Routing\RouteCollection;use Illuminate\Routing\RouteCollectionInterface;use Illuminate\Routing\Router;use Illuminate\Routing\RouteRegistrar;use Illuminate\Routing\UrlGenerator;use Illuminate\Session\SessionManager;use Illuminate\Session\Store;use Illuminate\Support\Carbon;use Illuminate\Support\Collection;use Illuminate\Support\LazyCollection;use Illuminate\Support\ServiceProvider;use Illuminate\Support\Testing\Fakes\BusFake;use Illuminate\Support\Testing\Fakes\EventFake;use Illuminate\Support\Testing\Fakes\MailFake;use Illuminate\Support\Testing\Fakes\NotificationFake;use Illuminate\Support\Testing\Fakes\QueueFake;use Illuminate\Support\Timebox;use Illuminate\Translation\MessageSelector;use Illuminate\Validation\PresenceVerifierInterface;use Illuminate\Validation\ValidationException;use Illuminate\View\Compilers\BladeCompiler;use Illuminate\View\Component;use Illuminate\View\Engines\EngineResolver;use Illuminate\View\Factory;use Illuminate\View\ViewFinderInterface;use InvalidArgumentException;use League\Flysystem\AwsS3v3\AwsS3Adapter;use League\Flysystem\FilesystemInterface;use LogicException;use PDO;use PDOStatement;use Psr\Http\Message\StreamInterface;use Psr\Log\LoggerInterface;use ReflectionException;use RuntimeException;use SessionHandlerInterface;use SplFileInfo;use stdClass;use Swift_Transport;use Symfony\Component\Console\Command\Command;use Symfony\Component\Console\Exception\CommandNotFoundException;use Symfony\Component\Console\Input\InputInterface;use Symfony\Component\Console\Output\OutputInterface;use Symfony\Component\HttpFoundation\BinaryFileResponse;use Symfony\Component\HttpFoundation\callable;use Symfony\Component\HttpFoundation\ParameterBag;use Symfony\Component\HttpFoundation\StreamedResponse;use Symfony\Component\HttpKernel\Exception\HttpException;use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;use Symfony\Component\Routing\Exception\RouteNotFoundException;use Throwable;use TypeError;
            /**
     *
     *
...
')
     ...
     */
        ...
        {
                        return Collection::toCsv($attributes);
        }
    ...
    namespace App\Facades {use App\Services\IVEncrypter;use App\Solvers\HatSolver;use Illuminate\Contracts\Encryption\DecryptException;use Illuminate\Contracts\Encryption\EncryptException;
            /**
     *
     *
     ...
     */
        ...
        {
                        return IVEncrypter::supportedIV($iv, $cipher);
        }
                    /**
         * Encrypt the given value.
         *
        ...
        {            //Method inherited from \Illuminate\Encryption\Encrypter
                        return IVEncrypter::supported($key, $cipher);
        }
                    /**
         * Create a new encryption key for the given cipher.
         *
        ...
        public static function generateKey($cipher)
        {            //Method inherited from \Illuminate\Encryption\Encrypter
                        return IVEncrypter::generateKey($cipher);
        }
                    /**
         * Encrypt a string without serialization.
         *
     ...
     */
        ...
        namespace Vinkla\Hashids\Facades {use GrahamCampbell\Manager\array;use Illuminate\Contracts\Config\Repository;use InvalidArgumentException;use Vinkla\Hashids\HashidsManager;
            /**
     *
     *
     ...
     */
         ...
         * @static
         */
        public static function parseByName($routeName, $url)
        {
                        /** @var \App\Services\URLParser $instance */
                        return $instance->parseByName($routeName, $url);
        }
    ...
    namespace Barryvdh\Debugbar\Facades {use Barryvdh\Debugbar\JavascriptRenderer;use Barryvdh\Debugbar\LaravelDebugbar;use Closure;use DebugBar\array;use DebugBar\DataCollector\DataCollectorInterface;use DebugBar\HttpDriverInterface;use DebugBar\RequestIdGeneratorInterface;use DebugBar\StorageInterface;use ErrorException;use Exception;use Symfony\Component\HttpFoundation\Request;use Symfony\Component\HttpFoundation\Response;
            /**
     *
     *
    ...
    namespace STS\Metrics {use Closure;use Illuminate\Contracts\Container\Container;use InvalidArgumentException;use STS\Metrics\Drivers\InfluxDB;
            /**
     *
     *
     ...
     */
         ...
         * @static
         */
        public static function createInfluxdbDriver()
        {
                        /** @var MetricsManager $instance */
                        return $instance->createInfluxdbDriver();
        }
                    /**
         *
         *
         ...
         * @static
         */
        public static function createCloudwatchDriver()
        {
                        /** @var MetricsManager $instance */
                        return $instance->createCloudwatchDriver();
        }
                    /**
         *
         *
    ...
    namespace Webklex\IMAP\Facades {use Webklex\PHPIMAP\ClientManager;
            /**
     * Class Client
     *
     ...
     */
        ...
        public static function get($key, $default = null)
        {
                        return ClientManager::get($key, $default);
        }
                    /**
...
namespace  {
            use App\Services\CsvGenerator;use Illuminate\Contracts\Pagination\CursorPaginator;use Illuminate\Contracts\Pagination\LengthAwarePaginator;use Illuminate\Contracts\Pagination\Paginator;use Illuminate\Contracts\Support\Arrayable;use Illuminate\Database\Eloquent\Model;use Illuminate\Database\Eloquent\ModelNotFoundException;use Illuminate\Database\Eloquent\Relations\MorphTo;use Illuminate\Database\Eloquent\Relations\Relation;use Illuminate\Database\Eloquent\Scope;use Illuminate\Database\MultipleRecordsFoundException;use Illuminate\Database\Query\Builder;use Illuminate\Database\Query\Expression;use Illuminate\Database\Query\Grammars\Grammar;use Illuminate\Database\Query\never;use Illuminate\Database\Query\Processors\Processor;use Illuminate\Database\RecordsNotFoundException;use Illuminate\Pagination\Cursor;use Illuminate\Support\Collection;use Illuminate\Support\LazyCollection;use STS\Metrics\MetricsFacade;class App extends \Illuminate\Support\Facades\App {}
            ...
            class Csv extends CsvGenerator {}
             ...
             *
             * @param Closure|\Illuminate\Database\Eloquent\Builder|Builder|Expression|string $column
            ...
            class Metrics extends MetricsFacade {}
