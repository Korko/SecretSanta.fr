...
')
     ...
     */ 
        ...
        public static function getDefaultDriver()
        {
                        /** @var \STS\Metrics\MetricsManager $instance */
                        return $instance->getDefaultDriver();
        }
                    /**
         * 
         *
         * @return \STS\Metrics\Drivers\InfluxDB 
         * @static 
         */ 
         ...
         * 
         *
         * @return \STS\Metrics\Drivers\LogDriver 
         * @static 
         */ 
        public static function createLogDriver()
        {
                        /** @var \STS\Metrics\MetricsManager $instance */
                        return $instance->createLogDriver();
        }
                    /**
         * 
         *
         ...
         * @param string $driver
         * @param \Closure $callback
         * @return \STS\Metrics\MetricsManager 
         * @static 
         */ 
        public static function extend($driver, $callback)
        {            //Method inherited from \Illuminate\Support\Manager         
