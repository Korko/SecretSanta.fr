...
/* harmony import */ var jquery_actual__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! jquery.actual */ "./node_modules/jquery.actual/jquery.actual.js");
/* harmony import */ var jquery_actual__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(jquery_actual__WEBPACK_IMPORTED_MODULE_14__);
/* harmony import */ var jquery_scrollto__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! jquery.scrollto */ "./node_modules/jquery.scrollto/jquery.scrollTo.js");
/* harmony import */ var jquery_scrollto__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(jquery_scrollto__WEBPACK_IMPORTED_MODULE_15__);
/* harmony import */ var _partials_alertify_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./partials/alertify.js */ "./resources/js/partials/alertify.js");
...
Modernizr.on('webp', function (result) {
  if (!result) {
    jquery__WEBPACK_IMPORTED_MODULE_13___default()('body').addClass('nowebp');
  }
});
...
(function ($, sr) {
  ...
  (jquery__WEBPACK_IMPORTED_MODULE_13___default().fn)[sr] = function (fn) {
    return fn ? this.bind('resize', debounce(fn)) : this.trigger(sr);
  };
})((jquery__WEBPACK_IMPORTED_MODULE_13___default()), 'smartresize');
...
jquery__WEBPACK_IMPORTED_MODULE_13___default()(document).ready(function () {
  ...
  function setHomeBannerHeight() {
    var windowHeight = jquery__WEBPACK_IMPORTED_MODULE_13___default()(window).height();
    jquery__WEBPACK_IMPORTED_MODULE_13___default()('#header').height(windowHeight);
  } /// ////////////////////////////
  ...
  function centerHomeBannerText() {
    var bannerText = jquery__WEBPACK_IMPORTED_MODULE_13___default()('#header > .center');
    var bannerTextTop = jquery__WEBPACK_IMPORTED_MODULE_13___default()('#header').actual('height') / 2 - jquery__WEBPACK_IMPORTED_MODULE_13___default()('#header > .center').actual('height') / 2 - 20; // var bannerTextTop = Math.min(jQuery('#header').actual('height'), (jQuery('#header').actual('height')/2) - (jQuery('#header > .center').actual('height')/2) - 20 + jQuery('html').scrollTop());
  ...
  jquery__WEBPACK_IMPORTED_MODULE_13___default()(window).smartresize(function () {
    setHomeBannerHeight();
  ...
  function scroll() {
    ...
    if (jquery__WEBPACK_IMPORTED_MODULE_13___default()(document).scrollTop() > 200) {
      jquery__WEBPACK_IMPORTED_MODULE_13___default()('body').addClass('scrolled');
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_13___default()('body').removeClass('scrolled');
    }
  }

  document.onscroll = scroll;
  var $scrollDownArrow = jquery__WEBPACK_IMPORTED_MODULE_13___default()('#scrollDownArrow');
  ...
  jquery__WEBPACK_IMPORTED_MODULE_13___default()('#scrollDownArrow').click(function (e) {
    e.preventDefault();
    jquery__WEBPACK_IMPORTED_MODULE_13___default().scrollTo('#what', 1000, {
      offset: -jquery__WEBPACK_IMPORTED_MODULE_13___default()('#header #menu').height(),
      axis: 'y'
    });
  });
  jquery__WEBPACK_IMPORTED_MODULE_13___default()('#navbar .nav > li > a[href^=\'#\'], #logo a[href^=\'#\']').click(function (e) {
    e.preventDefault();
    jquery__WEBPACK_IMPORTED_MODULE_13___default().scrollTo(jquery__WEBPACK_IMPORTED_MODULE_13___default()(this).attr('href'), 400, {
      offset: -jquery__WEBPACK_IMPORTED_MODULE_13___default()('#header #menu').height(),
      axis: 'y'
    });
  });
...
if (window.global && window.global.alert) {
  _partials_alertify_js__WEBPACK_IMPORTED_MODULE_16__.default.alert(window.global.alert);
}
...
vue__WEBPACK_IMPORTED_MODULE_17__.default.directive('tooltip', {
