...
/* harmony import */ var jquery_actual__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! jquery.actual */ "./node_modules/jquery.actual/jquery.actual.js");
/* harmony import */ var jquery_actual__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(jquery_actual__WEBPACK_IMPORTED_MODULE_15__);
/* harmony import */ var jquery_scrollto__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! jquery.scrollto */ "./node_modules/jquery.scrollto/jquery.scrollTo.js");
/* harmony import */ var jquery_scrollto__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(jquery_scrollto__WEBPACK_IMPORTED_MODULE_16__);
/* harmony import */ var _partials_alertify_js__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./partials/alertify.js */ "./resources/js/partials/alertify.js");
...
Modernizr.on('webp', function (result) {
  if (!result) {
    jquery__WEBPACK_IMPORTED_MODULE_14___default()('body').addClass('nowebp');
  }
});
...
(function ($, sr) {
  ...
  (jquery__WEBPACK_IMPORTED_MODULE_14___default().fn)[sr] = function (fn) {
    return fn ? this.bind('resize', debounce(fn)) : this.trigger(sr);
  };
})((jquery__WEBPACK_IMPORTED_MODULE_14___default()), 'smartresize');
...
jquery__WEBPACK_IMPORTED_MODULE_14___default()(document).ready(function () {
  ...
  function setHomeBannerHeight() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_14___default()('#header').height(windowHeight);
  } /// ////////////////////////////
  ...
  function centerHomeBannerText() {
    var bannerText = jquery__WEBPACK_IMPORTED_MODULE_14___default()('#header > .center');
    var bannerTextTop = jquery__WEBPACK_IMPORTED_MODULE_14___default()('#header').actual('height') / 2 - jquery__WEBPACK_IMPORTED_MODULE_14___default()('#header > .center').actual('height') / 2 - 20; // var bannerTextTop = Math.min(jQuery('#header').actual('height'), (jQuery('#header').actual('height')/2) - (jQuery('#header > .center').actual('height')/2) - 20 + jQuery('html').scrollTop());
  ...
  jquery__WEBPACK_IMPORTED_MODULE_14___default()(window).smartresize(function () {
    setHomeBannerHeight();
  ...
  function scroll() {
    ...
    if (jquery__WEBPACK_IMPORTED_MODULE_14___default()(document).scrollTop() > 200) {
      jquery__WEBPACK_IMPORTED_MODULE_14___default()('body').addClass('scrolled');
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_14___default()('body').removeClass('scrolled');
    }
  }

  document.onscroll = scroll;
  var $scrollDownArrow = jquery__WEBPACK_IMPORTED_MODULE_14___default()('#scrollDownArrow');
  ...
  jquery__WEBPACK_IMPORTED_MODULE_14___default()('#scrollDownArrow').click(function (e) {
    e.preventDefault();
    jquery__WEBPACK_IMPORTED_MODULE_14___default().scrollTo('#what', 1000, {
      offset: -jquery__WEBPACK_IMPORTED_MODULE_14___default()('#header #menu').height(),
      axis: 'y'
    });
  });
  jquery__WEBPACK_IMPORTED_MODULE_14___default()('#navbar .nav > li > a[href^=\'#\'], #logo a[href^=\'#\']').click(function (e) {
    e.preventDefault();
    jquery__WEBPACK_IMPORTED_MODULE_14___default().scrollTo(jquery__WEBPACK_IMPORTED_MODULE_14___default()(this).attr('href'), 400, {
      offset: -jquery__WEBPACK_IMPORTED_MODULE_14___default()('#header #menu').height(),
      axis: 'y'
    });
  });
...
if (window.global && window.global.alert) {
  _partials_alertify_js__WEBPACK_IMPORTED_MODULE_17__["default"].alert(window.global.alert);
}
...
vue__WEBPACK_IMPORTED_MODULE_18__["default"].directive('tooltip', {
  inserted: function inserted(el, binding, vnode) {
    ...
    div.appendChild(el);
    if (binding.value.img) if (_typeof(binding.value.img) === 'object' || binding.value.img instanceof Object) {
      var img = '<picture>';
      Object.keys(binding.value.img).forEach(function (mime) {
    ...
    div2.innerHTML = binding.value.img + '<div class="text-content">' + (binding.value.text || binding.value) + '</div>' + '<i></i>';
    div.appendChild(div2);
  }
});
vue__WEBPACK_IMPORTED_MODULE_18__["default"].component('dashboard', function () {
  return Promise.all(/*! import() */[__webpack_require__.e("js/vendors-jquery"), __webpack_require__.e("js/vendors-ui"), __webpack_require__.e("resources_js_components_dashboard_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! ./components/dashboard.vue */ "./resources/js/components/dashboard.vue"));
});
vue__WEBPACK_IMPORTED_MODULE_18__["default"].component('faq', function () {
  return Promise.all(/*! import() */[__webpack_require__.e("js/vendors-jquery"), __webpack_require__.e("js/vendors-ui"), __webpack_require__.e("resources_js_components_faq_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! ./components/faq.vue */ "./resources/js/components/faq.vue"));
});
vue__WEBPACK_IMPORTED_MODULE_18__["default"].component('c404', function () {
  return Promise.all(/*! import() */[__webpack_require__.e("js/vendors-jquery"), __webpack_require__.e("js/vendors-ui"), __webpack_require__.e("resources_js_components_404_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! ./components/404.vue */ "./resources/js/components/404.vue"));
});
...
/******/ __webpack_require__.O(0, ["js/vendors-jquery","js/vendors-ui","js/vendors-vue"], function() { return __webpack_exec__("./resources/js/common.js"); });
