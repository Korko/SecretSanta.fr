...
vue__WEBPACK_IMPORTED_MODULE_11__.default.use(vuelidate__WEBPACK_IMPORTED_MODULE_12__.default);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {//console.debug(await listen());
  ...
  methods: {
    ...
    resend: function resend(k) {
      ...
      return _partials_axios_js__WEBPACK_IMPORTED_MODULE_13__.default.post(this.data.resendEmailUrls[this.data.emails[k].id]);
    },
      ...
      return _partials_axios_js__WEBPACK_IMPORTED_MODULE_13__.default.get(this.routes.fetchStateUrl).then(function (response) {
        if (response.data.emails) {
          Object.values(response.data.emails).forEach(function (email) {
            ...
            var old_update = new Date(_this.data.emails[email.id].mail.updated_at);
            _this.data.emails[email.id].mail.delivery_status = new_update > old_update ? email.mail.delivery_status : _this.data.emails[email.id].mail.delivery_status;
          });
        }
      });
    },
