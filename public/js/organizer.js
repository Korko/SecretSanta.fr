...
/* harmony import */ var alertify_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! alertify.js */ "./node_modules/alertify.js/dist/js/alertify.js");
/* harmony import */ var alertify_js__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(alertify_js__WEBPACK_IMPORTED_MODULE_16__);
      ...
      return jquery__WEBPACK_IMPORTED_MODULE_15___default.a.ajax({
        ...
        success: function success(data, textStatus, jqXHR) {
          ...
          if (jqXHR.responseJSON) {
            if (jqXHR.responseJSON.message) alertify_js__WEBPACK_IMPORTED_MODULE_16___default.a.success(jqXHR.responseJSON.message);
        ...
        error: function error(jqXHR) {
          if (jqXHR.responseJSON && jqXHR.responseJSON.message) alertify_js__WEBPACK_IMPORTED_MODULE_16___default.a.error(jqXHR.responseJSON.message);
        }
      });
    },
...
/* harmony import */ var _partials_store_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../partials/store.js */ "./resources/js/partials/store.js");
...
/* harmony import */ var _inputEdit_vue__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./inputEdit.vue */ "./resources/js/components/inputEdit.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    InputEdit: _inputEdit_vue__WEBPACK_IMPORTED_MODULE_14__["default"]
  },
