...
vue__WEBPACK_IMPORTED_MODULE_8__.default.use((vuejs_dialog__WEBPACK_IMPORTED_MODULE_6___default()));
...
/* harmony default export */ __webpack_exports__["default"] = ({
                ...
                window.addEventListener('load', function () {
                  navigator.serviceWorker.register('/sw.js').then(function (registration) {
                    return registration.pushManager.getSubscription().then( /*#__PURE__*/function () {
                      var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(registration) {
  ...
  methods: {
      ...
      return (0,_partials_fetch_js__WEBPACK_IMPORTED_MODULE_11__.default)(this.routes.fetchStateUrl).then(function (response) {
        if (response.data.participants) {
          Object.values(response.data.participants).forEach(function (participant) {
            ...
            var old_update = new Date(_this.data.participants[participant.hash].mail.updated_at);
            _this.data.participants[participant.hash].mail.delivery_status = new_update > old_update ? participant.mail.delivery_status : _this.data.participants[participant.hash].mail.delivery_status;
          });
        }
      });
    },
    ...
    download: function download() {
      ...
      (0,_partials_fetch_js__WEBPACK_IMPORTED_MODULE_11__.default)(this.routes.csvInitUrl, {
        responseType: 'blob'
      }).then(function (response) {
        if (response.data) (0,_partials_helpers_js__WEBPACK_IMPORTED_MODULE_9__.download)(response.data, 'secretsanta_' + _this3.expirationDateShort + '_init.csv', 'text/csv');
      });
    },
    downloadPlus: function downloadPlus() {
      ...
      axios.get(this.routes.csvFinalUrl, {
        ...
        if (response.data) (0,_partials_helpers_js__WEBPACK_IMPORTED_MODULE_9__.download)(response.data, 'secretsanta_' + _this4.expirationDateShort + '_full.csv', 'text/csv');
      });
    },
