...
var render = function() {
  ...
  return _c("div", [
    _c(
      "table",
      _vm._l(_vm.draws, function(draw, hash) {
        return _c("tr", [
          _c("td", [_vm._v(_vm._s(hash))]),
          _vm._v(" "),
          _c("td", [_vm._v(_vm._s(draw.title))]),
          _vm._v(" "),
          _c("td", [_vm._v(_vm._s(draw.creation))]),
          _vm._v(" "),
          _c("td", [_vm._v(_vm._s(draw.expiration))]),
          _vm._v(" "),
          _c("td", [_vm._v(_vm._s(draw.organizerName))]),
          _vm._v(" "),
          _c("td", [_vm._v(_vm._s(draw.links))])
        ])
      }),
      0
    )
