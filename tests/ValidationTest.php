...
class ValidationTest extends RequestCase
{
    ...
    {
        $content = $this->ajaxPost('/', ['name' => ['toto', 'tata'], 'phone' => ['0612345678', '0612345678'], 'dearsanta' => '0'], 422);
        $this->assertArrayKeysEquals(['g-recaptcha-response', 'contentSMS'], $content);

        $content = $this->ajaxPost('/', ['name' => ['toto', 'tata'], 'phone' => ['0612345678', '0612345678'], 'dearsanta' => '1'], 422);
        $this->assertArrayKeysEquals(['g-recaptcha-response', 'contentSMS', 'email.0', 'email.1'], $content);
    }
